...
import { IMG_DX, IMG_MOON_CAKE, IMG_SONG_MISSING, IMG_STD, LEVEL_COLOR } from '../../consts';
			...
			<div style={{ flexGrow: 1, backgroundColor: 'rgba(255, 255, 255, 0.8)', display: 'flex', justifyContent: 'left', alignItems: 'center', padding: '0 5px' }}>
				<div style={{ flexGrow: 1 }}>
					...
					{chart && <div>
						...
						<span style={{ fontWeight: 700 }}>{compute.ra(chart.internalLevelValue, entry.achievement)}</span>
					</div>}
				</div>
				<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
					<img src={convert.getRankImage(convert.achievementToRank(entry.achievement))} alt="" height={30} />
